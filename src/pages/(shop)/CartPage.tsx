...
function CartPage() {
   ...
   return (
      <div
         ...
         <h1 className={twMerge(["text-2xl", "font-bold", "mb-8", ""])}>
            SHOPPING CART
         </h1>
            ...
            <div className="flex-1">
               <div
                  className={twMerge([
                     "flex",
                     "pb-3",
                     "text-sm font-bold text-center border-b border-black",
                  ])}>
                  <div className={twMerge(["w-full", "text-left", "pl-2"])}>
                     상품정보
                  </div>
                  <div className="w-24">수량</div>
                  <div className={twMerge(["w-32"])}>가격</div>
                  <div className={twMerge(["w-12"])}>___</div>
               </div>
               {items.map(item => {
                  ...
                  return (
                     <>
                        <div
                           ...
                           <div
                              className={twMerge(["w-full", "flex", "gap-4"])}>
                              <div
                                 className={twMerge([
                                    "w-24",
                                    "h-28",
