    ...
    return (
        <header
            ...
            <div
                ...
                {/* 1. 로고 영역 (고정 너비) */}
                <div className={twMerge(["w-40", "flex", "items-center", "gap-5", "flex-shrink-0"])}>
                ...
                {/* 3. 우측 메뉴 영역 (고정 너비) */}
                <div className={twMerge(["w-100", "flex", "justify-end", "items-center", "gap-5", "flex-shrink-0"])}>
            ...
            <div
                ...
                <div
                    ...
                    {/* 1. 로고 공간 확보 (상단과 동일한 w-40) */}
                    <div className={twMerge(["w-40", "flex-shrink-0"])} />
                    
                    {/* 2. 서브 메뉴 리스트 (상단 GNB와 동일한 구조) */}
                    <div
                        className={twMerge(
                            ["hidden", "lg:flex", "flex-1"],
                            ["justify-center", "gap-10"],
                    ...
                    {/* 3. 우측 공간 확보 (상단과 동일한 w-100) */}
                    <div className={twMerge(["w-100", "flex-shrink-0"])} />
                </div>
            </div>
        </header>
    );
